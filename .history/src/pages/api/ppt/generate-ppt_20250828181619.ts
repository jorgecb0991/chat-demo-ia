...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log("if1:"+(sourceTypeForBackend === "url" && fields.sourceValue));
    console.log("if2:"+(sourceTypeForBackend === "url" && fields.sourceValue));
    
    if (sourceTypeForBackend === "url" && fields.sourceValue) {

      console.log("if:"+(sourceTypeForBackend === "url" && fields.sourceValue));
