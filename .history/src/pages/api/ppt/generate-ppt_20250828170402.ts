...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    form.append("sourceType", req.get("sourceType"));
    form.append("title",req.get("sourceType"));
    form.append("slide_count",req.get("sourceType"));
    form.append("template",req.get("sourceType"));
