...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    payload.append("source_value",fields.sourceType);
    payload.append("title",fields.sourceType);
    payload.append("slide_count",fields.sourceType);
    payload.append("template",fields.sourceType);
    payload.append("user_id",fields.sourceType);
    payload.append("session_id",fields.sourceType);
    payload.append("instruction_teacher",fields.sourceType);
