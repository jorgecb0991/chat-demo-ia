        ...
        <div className="flex flex-col w-full">
            ...
            <Tabs.Root value={sourceType} onValueChange={onTypeChange} className="w-full">
                ...
                <Tabs.Content value="file">
                    <label
                        htmlFor="file-upload"
                        className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
                    >
                        <UploadCloud className="w-12 h-12 mb-3 text-gray-400" />
                        <span className="text-gray-600 font-medium">Haz click o arrastra un archivo aquí</span>
                        <input
                        id="file-upload"
                        type="file"
                        className="hidden"
