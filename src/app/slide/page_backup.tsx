...
export default function SlideGeneratorPage() {
  ...
  const generarSlides = async () => {
    ...
    try {
      ...
      // Si no es archivo → enviamos el valor (topic, text, youtube, webpage)
      ...
      alert("Ocurrió un error al generar la presentación: " + (error as Error).message);
    } finally {
      setLoading(false);
    }
  };
          ...
          {isYoutube ? (
            <div className="flex flex-col items-center gap-4">
              <div className="relative w-20 h-20 animate-pulse">
                <Image
                  src="/img/logo_utec_youtube.png" // pon aquí tu logo de YouTube en public/
                  alt="YouTube"
                  fill
        ...
        <div className="space-y-4">
          <SourceMaterialInput
            ...
            onFileChange={(bytes, type) => {
              setFileBytes(bytes);
              setMimeType(type);
              console.log("Archivo recibido:", { size: bytes.length, type });
            }}
          />
