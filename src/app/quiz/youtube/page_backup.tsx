...
export default function YoutubeQuizPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 font-sans">
            <div className="bg-gray-50 rounded-2xl shadow-xl w-full max-w-3xl p-6 space-y-4">
                <h1 className="text-2xl font-semibold text-gray-900 text-center">Crear YouTube Quiz</h1>
                ...
                <div className="bg-blue-50 rounded-lg p-2 flex flex-col items-center ">
                    ...
                    {!videoThumbnail && (<div className="w-full flex items-center relative">
                        <input
                            type="text"
                    ...
                    {videoThumbnail && (
                        <div className="relative w-80 mt-2 rounded shadow-md overflow-hidden flex justify-center">
                            {/* Enlace clickeable solo en la miniatura */}
                            <a
                                href={youtubeUrl}
                                target="_blank"
                            ...
                            >
                                ...
                                />
                                {/* Botón de reproducción dentro del enlace */}
                                <button
                            ...
                            {/* Botón para eliminar miniatura, fuera del enlace */}
                            <button
                ...
                <Button
                    className="w-full rounded-lg  py-2 mt-4 bg-red-600 hover:bg-red-500 text-white"
